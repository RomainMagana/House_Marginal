...
public class Arene extends JFrame implements Global {
	...
	public Arene(String typeJeu, Controle controle) {
		...
		setBounds(100, 100, L_ARENE + 3*MARGE+ L_CHAT, H_ARENE + 35);
		...
		if (client) {
			...
			txtSaisie.setBounds(L_ARENE + MARGE, 0 + MARGE, L_ARENE, H_SAISIE);
...
//		jspChat.setBounds(0, H_ARENE + H_SAISIE, L_ARENE, H_CHAT - H_SAISIE - 7*MARGE);
		jspChat.setBounds(L_ARENE + MARGE, 0 + H_SAISIE + MARGE, L_CHAT, H_CHAT - H_SAISIE - 7*MARGE);
